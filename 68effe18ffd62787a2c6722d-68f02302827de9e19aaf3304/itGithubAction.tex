...
\begin{itemize}
    \item The \textbf{current version code} (Git SHA + UTC timestamp)
    \item The \textbf{page number} on the right
    \item A \textbf{context label} (e.g., ``Overleaf GitHub Integration'') on the left
\end{itemize}
