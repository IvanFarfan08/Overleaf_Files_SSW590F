...
\begin{itemize}[topsep=0pt,itemsep=0pt,parsep=0pt,partopsep=0pt,leftmargin=12pt]
    \item Added \hyperref[Chapter::itGithubAction]{Create a GitHub Action to Automatically Compile your LaTeX Document and Store Versions} chapter for Homework 7, documenting the GitHub Actions workflow used to automate Overleaf compilation and versioning.
