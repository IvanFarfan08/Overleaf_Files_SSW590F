...
\newcommand{\fileversion}{build-HW9-v9.1.0}
...
\include{itBugzilla}
\include{itOverleaf}
\include{itOverleafGithub}
\include{itGithubAction}
\include{itPrometheusGrafana}
\include{itJenkins}
\include{itLoadBalancerVirtualHost}
\include{itFinalProject}
\include{itfinaliproject}
