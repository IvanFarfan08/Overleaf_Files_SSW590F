...
The service shows as active and correctly pushes changes from the Overleaf compile directories to GitHub whenever a new project is compiled. The repo is available at \hyperref[https://github.com/IvanFarfan08/Overleaf_Files_SSW590F]{}